...
public class AStarState
{
    ...
    public Waypoint getMinOpenWaypoint()
    {
        ...
        Iterator<Map.Entry<Location, Waypoint>> iterator = open.entrySet().iterator();
        ...
        for (Waypoint currentWaypoint:open.values()){
    ...
    public boolean addOpenWaypoint(Waypoint newWP)
    {
        ...
        for (Map.Entry<Location, Waypoint> item: open.entrySet()) {
